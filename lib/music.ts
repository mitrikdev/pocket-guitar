...
export const STRUCTURES: readonly Structure[] = [
  ...
  { id: 'major-6', name: 'Major 6', type: 'chord', intervals: [intervals[0], intervals[4], intervals[7], intervals[9]] },
  { id: 'minor-6', name: 'Minor 6', type: 'chord', intervals: [intervals[0], intervals[3], intervals[7], intervals[9]] },
  { id: 'add9', name: 'Add9', type: 'chord', intervals: [intervals[0], intervals[4], intervals[7], {"semitones":2,"degree":"9","short":"M9","name":"Major 9th"}] },
  { id: 'dominant-9', name: 'Dominant 9', type: 'chord', intervals: [intervals[0], intervals[4], intervals[7], intervals[10], {"semitones":2,"degree":"9","short":"M9","name":"Major 9th"}] },
  { id: 'major-9', name: 'Major 9', type: 'chord', intervals: [intervals[0], intervals[4], intervals[7], intervals[11], {"semitones":2,"degree":"9","short":"M9","name":"Major 9th"}] },
  { id: 'minor-9', name: 'Minor 9', type: 'chord', intervals: [intervals[0], intervals[3], intervals[7], intervals[10], {"semitones":2,"degree":"9","short":"M9","name":"Major 9th"}] },
  { id: 'diminished-7', name: 'Diminished 7', type: 'chord', intervals: [intervals[0], intervals[3], intervals[6], {"semitones":9,"degree":"♭♭7","short":"d7","name":"Diminished 7th"}] },
  { id: 'half-diminished', name: 'Minor 7♭5', type: 'chord', intervals: [intervals[0], intervals[3], intervals[6], intervals[10]] },
  { id: '7sus4', name: '7sus4', type: 'chord', intervals: [intervals[0], intervals[5], intervals[7], intervals[10]] },
  { id: 'dominant-11', name: 'Dominant 11', type: 'chord', intervals: [intervals[0], intervals[4], intervals[7], intervals[10], {"semitones":2,"degree":"9","short":"M9","name":"Major 9th"}, {"semitones":5,"degree":"11","short":"P11","name":"Perfect 11th"}] },
  { id: 'dominant-13', name: 'Dominant 13', type: 'chord', intervals: [intervals[0], intervals[4], intervals[7], intervals[10], {"semitones":2,"degree":"9","short":"M9","name":"Major 9th"}, {"semitones":5,"degree":"11","short":"P11","name":"Perfect 11th"}, {"semitones":9,"degree":"13","short":"M13","name":"Major 13th"}] },
